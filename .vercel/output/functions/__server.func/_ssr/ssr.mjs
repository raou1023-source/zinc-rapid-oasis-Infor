...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CrYC0I2E.mjs");
...
var manifest = {
	"2cfd3bab1d80196bfc55c67eed770c6fa6fcde12277a6db4126af0cdbe297445": {
		functionName: "getArticle_createServerFn_handler",
		importer: () => import("./server-BSDhDaIh.mjs")
	},
	"f83726ec62b4844a0fb54d8984156fd242fbfc593dd47859ff1754beb11bac3e": {
		functionName: "getNews_createServerFn_handler",
		importer: () => import("./server-BSDhDaIh.mjs")
	},
	"f91f64fa300b05cb48f7a3e56d3bea704126251656178c86b34c9ea38f5794be": {
		functionName: "getSportNews_createServerFn_handler",
		importer: () => import("./server-BSDhDaIh.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-qeoWsEao.mjs").then((n) => n.t),
